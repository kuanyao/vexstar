...
#pragma config(Sensor, dgtl3,  Jumper3,        sensorNone)
#pragma config(Sensor, dgtl4,  Jumper4,        sensorNone)
#pragma config(Sensor, dgtl5,  Jumper5,        sensorNone)
...
#pragma config(Motor,  port5,           RightBackMotor, tmotorVex393HighSpeed_MC29, openLoop, encoderPort, dgtl9)
