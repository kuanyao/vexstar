...
#pragma config(Motor,  port2,           leftMotor,     tmotorVex393HighSpeed_MC29, openLoop, driveLeft, encoderPort, I2C_2)
#pragma config(Motor,  port3,           rightMotor,    tmotorVex393HighSpeed_MC29, openLoop, driveRight, encoderPort, I2C_1)
